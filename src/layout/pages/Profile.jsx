    ...
    <div className="overflow-hidden rounded-sm  bg-transparent shadow-default dark:border-strokedark dark:bg-boxdark">
      <div className="relative z-20 h-35 md:h-65">
        ...
        <div className="absolute bottom-1 right-1 z-10 xsm:bottom-4 xsm:right-4">
          <label
            htmlFor="cover"
            className="flex cursor-pointer items-center justify-center gap-2 rounded bg-[#4338CA] py-1 px-2 text-sm font-medium text-white hover:bg-opacity-90 xsm:px-4"
          >
      ...
      <div className="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
        <div className="relative z-30 mx-auto -mt-22 h-30 w-full max-w-30 rounded-full bg-white/20 p-1 backdrop-blur sm:h-44 sm:max-w-44 sm:p-3">
          <div className="relative drop-shadow-2">
            ...
            <label
              className="absolute bottom-0 right-0 flex h-8.5 w-8.5 cursor-pointer items-center justify-center rounded-full bg-[#4338CA] text-white hover:bg-opacity-90 sm:bottom-2 sm:right-2"
            >
              <svg
                className="fill-current"
                width="14"
        ...
        <div className="mt-4">
          ...
          <div className="w-full max-w-md items-center justify-center mx-auto mt-11 mb-5.5 grid max-w-94 grid-cols-3 rounded-md border border-n-6 py-2.5 shadow-1 dark:border-strokedark dark:bg-n-7">
            <div className="flex flex-col items-center justify-center gap-1 border-r border-n-6 px-4 dark:border-strokedark xsm:flex-row">
              ...
              <span className="text-sm text-n-10">Posts</span>
            </div>
            <div className="flex flex-col items-center justify-center gap-1 border-r border-n-6 px-4 dark:border-strokedark xsm:flex-row">
              <span className="font-semibold text-black dark:text-n-9">
                129K
              </span>
              <span className="text-sm text-n-10">Followers</span>
            </div>
            <div className="flex flex-col items-center justify-center gap-1 px-4 xsm:flex-row">
              <span className="font-semibold text-black dark:text-n-9">
                2K
              </span>
              <span className="text-sm text-n-10">Following</span>
            </div>
          </div>

          <div className="mx-auto mt-5 max-w-180 justify-center items-center text-center">
            <h4 className="font-semibold text-black dark:text-white">
              About Me
            </h4>
            <p className="mt-3 w-full max-w-2xl justify-center items-center text-center">
