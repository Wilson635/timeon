  ...
  return (
    <div className="container">
      ...
      <div className="content py-24">
        <p className="type">{view.charAt(0).toUpperCase() + view.slice(1)}</p>
      </div>
        ...
        {view === 'timer' && (
          <div className="timer">
            ...
            <div className="btns mt-44">
              <button className="btn start-timer" onClick={startTimer}>Start</button>
              <button className="btn stop-timer" onClick={stopTimer}>Stop</button>
              <button className="btn reset-timer" onClick={resetTimer}>Reset</button>
              <button className="btn back-btn" onClick={() => setView('clock')}>Back</button>
            </div>
          </div>
        )}
      </div>
