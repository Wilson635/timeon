...
const Sidebar = () => {
    ...
    return (
        <nav className="leftsidebar items-center divide-y divide-slate-900 justify-center p-3 border text-sm font-medium relative border-neutral-200 dark:border-white/[0.2] text-black dark:text-white">
